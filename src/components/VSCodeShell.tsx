...
export function VSCodeShell({ activeTab, children }: Props) {
  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden bg-surface-container-lowest">
      ...
      {/* ── TopAppBar ─────────────────────────────────────────────────────── */}
      <header className="shrink-0 flex items-center gap-3 px-4 h-9 bg-[#131313] z-50 border-b border-outline-variant/10">
      ...
      <div className="flex flex-grow overflow-hidden">
        ...
        {/* ── Activity Bar ─────────────────────────────────────────────── */}
        <nav className="w-12 bg-[#0e0e0e] shrink-0 flex flex-col items-center py-4 gap-1 z-40 border-r border-outline-variant/10">
          {/* Explorer toggle — opens/closes sidebar */}
          <button
          ...
          <div className="mt-auto flex flex-col items-center gap-3 pb-2">
            ...
            <div className="text-on-surface-variant opacity-50 hover:opacity-100 hover:text-primary transition-all cursor-pointer">
        ...
        <div className="relative flex flex-grow overflow-hidden">
          ...
          >
            <div className="w-56 flex flex-col h-full">
              ...
              <div className="flex flex-col overflow-y-auto scrollbar-ide">
                <div className="flex items-center gap-1 px-2 py-1 bg-surface-container-high text-on-surface-variant shrink-0">
                    ...
                    return (
                      <Link
                        ...
                        className={[
                          ...
                          isActive
                            ? 'bg-[#131313] text-primary border-l-2 border-primary-container'
          ...
          <main className="flex-grow flex flex-col overflow-hidden min-w-0">
            ...
            {/* Tab Bar */}
            <div className="shrink-0 flex h-9 bg-[#0e0e0e] overflow-x-auto scrollbar-ide border-b border-outline-variant/5">
              {openTabs.map((tabId) => {
                ...
                return (
                  <div
                    ...
                    className={[
                      ...
                      isActive
                        ? 'bg-[#131313] border-t-2 border-primary-container text-on-surface'
            ...
            {/* Editor content */}
            <div className="flex-grow overflow-auto scrollbar-ide bg-[#131313]">
      ...
      {/* ── Status Bar ────────────────────────────────────────────────────── */}
      <footer className="shrink-0 flex items-center h-6 px-2 gap-3 bg-[#0e0e0e] font-mono text-[10px] text-primary z-50">
        <div className="flex items-center gap-1 bg-primary-container text-white px-2 h-full cursor-pointer">
