    ...
    <div className="code-page">
      ...
      <div className="code-content p-4 pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 my-8">
          ...
          {/* Main education card */}
          <div className="lg:col-span-2 bg-surface-container border-l-4 border-code-blue p-6 shadow-xl relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
              <GraduationCap size={96} />
            </div>
            <div className="relative z-10">
              <h2 className="font-headline font-extrabold text-2xl text-code-blue tracking-tight mb-1">
                Ulm University
              </h2>
              <p className="text-muted font-mono text-foreground mb-1">
                M.Sc. Computer Science{' '}
                <span className="text-xs opacity-60">— Oct 2023 – Jun 2026</span>
              </p>
              <p className="text-muted font-mono text-xs mb-4 opacity-70 leading-relaxed">
                Thesis: &ldquo;Assessing the Effectiveness of Large Language Model Support for Generating GDPR ROPA Documentation&rdquo;
              </p>
              <p className="text-muted font-mono text-sm mb-1 border-t border-subtle/20 pt-3 opacity-80">
                B.Sc. Software Engineering{' '}
                <span className="text-xs opacity-60">— Oct 2019 – Jul 2023</span>
              </p>
              <p className="text-muted font-mono text-xs mb-4 opacity-60 leading-relaxed">
              ...
              <div className="flex flex-wrap gap-2 mb-5">
                {['System Architecture', 'Cybersecurity', 'Interaction Design', 'LLM Research'].map((tag) => (
                  <span
                    key={tag}
                    className="px-2 py-1 bg-surface-container-high text-code-blue text-xs font-mono"
                  >
                    {tag}
                  </span>
                ))}
              </div>
              <div className="bg-surface-container-lowest p-3 font-mono text-xs border border-subtle/20">
          ...
          {/* Skills sidebar card */}
          <div className="bg-surface-container p-5 border-l-4 border-code-orange shadow-xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-headline font-bold text-xs tracking-widest text-code-orange uppercase">
                Skills.json
              </h3>
              <Terminal size={15} className="text-code-orange" />
            </div>
            <div className="space-y-3 font-mono text-[11px] leading-tight text-muted">
              <div>
        ...
        {/* ── CTA block ────────────────────────────────────────────────── */}
        <div className="mt-10 mr-4 p-8 bg-gradient-to-br from-surface to-surface-container-high flex flex-col items-center justify-center text-center border border-subtle/10">
          <div className="w-14 h-14 mb-4 flex items-center justify-center bg-code-blue text-white">
            <Terminal size={24} />
          </div>
          <h3 className="font-headline font-black text-3xl mb-2 text-foreground">
            BUILD_THE_FUTURE()
          </h3>
          <p className="text-muted font-mono max-w-md mb-6 text-xs">
            Compiling expertise into production-ready solutions.
          </p>
          <a
            href="mailto:emilija1705@gmail.com"
            className="bg-gradient-to-r from-primary to-primary-container text-white font-mono px-8 py-2.5 font-bold text-sm hover:opacity-90 transition-opacity"
          >
            INITIALIZE_CONTACT
          </a>
        </div>
