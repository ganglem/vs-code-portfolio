    ...
    <div className="code-page">
      ...
      <div className="code-content p-4 pb-12">
        ...
        <p>
          ...
          <span className="text-muted"> &#123; Code, ExternalLink &#125; </span>
        ...
        {PROJECTS.map((project) => (
          <div key={project.varName} className="pl-3 mt-4">
            ...
            <div className="pl-3 space-y-0.5">
              ...
              <div className="pl-3">
                <p>
                  ...
                  <a
                    ...
                    className="syn-string underline decoration-dotted decoration-on-surface-variant hover:text-code-blue transition-colors"
                  >
                    &apos;{project.githubLabel}&apos;
                  </a>
                  <span className="text-muted">,</span>
              ...
              <div className="my-3 border border-subtle/20 bg-surface-container-low relative overflow-hidden max-w-2xl group">
                <div className="w-full h-40 lg:h-56 flex items-center justify-center bg-surface-container">
                  <span className="text-[11px] font-mono text-muted opacity-30 uppercase tracking-widest">
                    project screenshot
                  </span>
                </div>
